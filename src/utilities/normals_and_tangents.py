...
"""
    ...
    if tangent:
        if V.mesh.geometry.dim == 1:
            ...
            c = dfx.fem.Constant(V.mesh, (1.0, 0.0, 1.0)) # Vector to tangentially project the facet normal vectors on
            if interior:
                a = (ufl.inner(u('+'), v('+')) + ufl.inner(u('-'), v('-'))) * dS
...
if __name__ == '__main__':
    ...
    DG1 = element("DG", cell=mesh.ufl_cell(), degree=1, shape=(mesh.geometry.dim,))
