...
from utilities.deformation_data import WallDeformationCorpusCallosum, WallDeformationCanalWall
...
vh_out_CG2 = dfx.fem.Function(W)
vtx_CG2 = dfx.io.VTXWriter(comm, f"CG2_defo_velocity.bp", [vh_out_CG2], "BP4")
