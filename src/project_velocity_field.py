...
velocity_input_filename = \
    f"../output/checkpoints/deforming-mesh/{mesh_prefix}-BDM_chp+cilia+defo_brain_velocity"
...
if discontinuous_input:
    ...
    dg1_el = element("DG", mesh.basix_cell(), 1,   shape=(mesh.topology.dim,))
...
output_filename = f"../output/checkpoints/{mesh_prefix}-BDM_chp+cilia+defo_brain_velocity_CG1"
