...
if __name__=='__main__':
    ...
    mesh_file  = "../geometries/brain-meshes/midBrainMesh_labels.xdmf"
    facet_file = "../geometries/brain-meshes/midBrainMesh_label_boundaries.xdmf"
    output_filename = "../geometries/medium_ventricles_mesh.xdmf"
