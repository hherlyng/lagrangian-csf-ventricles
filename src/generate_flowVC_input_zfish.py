...
def main(argv=None):
    ...
    output_dir = "/global/D1/homes/hherlyng/flowVC/bin/zfish/"

    velocity_input_filename = \
        f"/global/D1/homes/hherlyng/lagrangian-csf-ventricles/output/zfish-mesh/" \
      + f"flow/checkpoints/{args.element_family}_velocity_projection"
    
    # Generate binary data
    generate_data(
                input_filename=velocity_input_filename,
                output_dir=output_dir,
                output_prefix=args.element_family
            )
