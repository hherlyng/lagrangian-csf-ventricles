...
\cite{shadden2005definition, haller2015lagrangian}. We want to
study LCS in brain ventricles, with the aim of gaining further
...
We consider an $\mathbf{H}(\mathrm{div})$-conforming discretization of equations using
...
the normal component of vectors on the facets of the mesh cells.
We can therefore impose~\eqref{eq:impermeability_BC}
on the boundary strongly. Owing to this strong imposition,
